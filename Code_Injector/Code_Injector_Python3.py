...
#File intercepter and code injector program python 3
    ...
    if scapy_packet.haslayer(scapy.RAW): #RAW is the raw layer of the packet
        ...
        try:
            ...
            if load != scapy_packet[scapy.Raw].load:
                ...
                packet.set_payload(bytes(new_packet)) #sets the payload of the modified packet

        except UnicodeDecodeError:
            pass #this will just move onto the next packet to annalize
