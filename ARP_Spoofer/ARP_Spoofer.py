...
try:
    ...
    while True:
        ...
        print("\r[+] Packets sent: " + str(sent_packets_count)), #prints the statement from the start of the line
        # the , makes it so the print statement keeps updating the same line
